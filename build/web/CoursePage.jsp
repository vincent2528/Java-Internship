...
<body>
    ...
    <section class="container-fluid px-0">
            ...
            <div class="col-md-6 text-center order-1 order-md-2">
                <div class="row justify-content-center">
                    <div class="col-10 col-lg-8 blurb mb-5 mb-md-0">
                        <h2>CIVIL/MECHANICAL</h2>
                        <img src="imgs/lolli_icon.png" alt="" class="d-none d-lg-inline">
                        <p class="lead">Civil Engineering is primarily about construction, design, and maintenance of the civil structures, infrastructures, and buildings. Mechanical engineering, on the other hand, in the simplest words is the engineering stream that deals in the mechanics of automobiles and other machines.</p>
                            <a href="CIVILcourse.jsp" class="btn btn-outline-success btn-sm" name="Civil">Give Test</a>
        ...
        <div class="row align-items-center content">
            <div class="col-md-6 text-center">
                <div class="row justify-content-center">
                    <div class="col-10 col-lg-8 blurb mb-5 mb-md-0">
                        <h2>COMPUTER SCIENCE/I.T.</h2>
                        <img src="imgs/lolli_icon.png" alt="" class="d-none d-lg-inline">
                        <p class="lead">Broadly, pursuing a degree in Computer Science involves the understanding of design, implementation, and management of information system of both software and hardware processes.

                            On the other hand, IT Engineering deals with installation, development, and implementation of computer systems and applications.</p>
                            <a href="CScourse.jsp" class="btn btn-outline-success btn-sm" name="Cs">Give Test</a>
                          <a href="#" class="btn btn-outline-danger btn-sm"><i class="far fa-heart"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 text-center order-1 order-md-2">
                <div class="row justify-content-center">
                    <div class="col-10 col-lg-8 blurb mb-5 mb-md-0">
                        ...
                        <img src="imgs/lolli_icon.png" alt="" class="d-none d-lg-inline">
                        <p class="lead">“Electrical & Electronics Engineering” is a growing and one of the most sought disciplines in the field of engineering study. It comprises with the electrical engineering and electronics engineering.

                            It is originated by the electrical engineering. By the technically modernization of the world and computerization in our work field, it is necessary to use and understand the circuits and computerized devices in electrical & electronic field.</p>
                            <a href="ELECcourse" class="btn btn-outline-success btn-sm" name="Electrical">Give Test</a>
                          <a href="#" class="btn btn-outline-danger btn-sm"><i class="far fa-heart"></i></a>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        myFunction(){
                if(this.id.localeCompare("Comps")){
                <%
                    s.setAttribute("subcourse","Computer");
                 %>
                }else if(this.id.localeCompare("Civil")){
                <%
                    s.setAttribute("subcourse","Civil");
                 %>
                }else(this.id.localeCompare("Electrical")){
                <%
                    s.setAttribute("subcourse","Electrical");
                 %>
                }
        }
    </script>
