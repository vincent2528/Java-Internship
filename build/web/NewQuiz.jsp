...
<body>
    ...
    <div class="ui main text container segment" id="kr">
        <div class="ui huge header">New Quiz</div>
        <form class="ui form" action="MakeQuiz.jsp">
        <div class="field">
        ...
        <select name="course" id="course">
          ...
          <select name="subcourse" id="subcourse">
        ...
        <div class="field">
            ...
            <select name="maxscore" id="maxscore" required>
