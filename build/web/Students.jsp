        ...
        <header class="jumbotron">
            ...
            <div class="row" style="display:flex; flex-wrap: wrap;">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <%                 
                            String admin=myRs.getString("u_isAdmin"); 
                            if(admin.equals("1")){
 %>
                        ...
                        <% }  %>
                        <div class="caption">
                         <h4><%= myRs.getString("u_name") %></h4>

                        </div>
                        <button type="submit" class="btn btn-outline-success btn-sm" name="<%= myRs.getString("u_id") %>">View Profile</button>
