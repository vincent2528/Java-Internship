...
<body>
    ...
    <div class="ui main text container segment" id="kr">
        ...
        <form class="ui form" action="HomePage.jsp">
        <div class="field">
            <label>Name :</label>
        ...
        <a href="EditPass.jsp" class="ui red button">Change Password</a>
        <button class="ui green button" type="submit">Return to Home</button>
